...
use SocialProBundle\Form\ProjectsType;
...
class ProjectsController extends Controller
{
    ...
    {$em = $this->getDoctrine()->getManager();
       $User=$this->get('security.token_storage')->getToken()->getUser();
        ...
        {
            $em = $this->getDoctrine()->getManager();
            $Project=$em->getRepository('SocialProBundle:Projects')->find($this->RdrProject);
            $deleteForm = $this->createDeleteForm($project);
            $this->get('knp_snappy.pdf')->generateFromHtml($this->renderView('SocialProBundle:Projects:show.html.twig',array('')));
        }*/
...
/*
...

    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $deleteForm = $this->createDeleteForm($project);
            try {
                $fs->mkdir('C:/Users/LordGoats/Desktop/My Projects/'.$project->getProjectName());
